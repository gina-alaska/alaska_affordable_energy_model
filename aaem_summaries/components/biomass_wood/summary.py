...
DESCRIPTION = """
    This component calculates the potential change in heating oil usage from the installation of new cordwood boilers in non-residential buildings (assumed to heat 30% of non-residential square footage). 
"""
