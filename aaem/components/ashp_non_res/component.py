...
class ASHPNonResidential (ashp_base.ASHPBase):
    """Non-Residential ASHP component of the Alaska Affordable Energy Model:
    This model estimates the potential reduction in heating fuel use from
    installation of Air Source Heat Pumps in Non-residential buildings.
    ...
    differential heating fuel costs and ASHP operation costs. The cost
    of the ASHP infrastructure projects are based on the number of
    non-residential buildings in the community and the cost of AHSP systems
    themselves.
    ...
    def load_prerequisite_variables (self, comps):
        ...
        ----------
        non_res_sqft : float
            Total square footage that may be refit of nonresidential buildings,
