...
class BiomassBase (AnnualSavings):
    """Biomass Base of the Alaska Affordable Energy Model: Base component
    ...
    def get_non_res_values (self, non_res):
        """Get the values necessary to run the biomass component from
    ...
    def calc_heat_displaced_sqft (self):
        """Calculates the square footage for which biomass will displace heating
    ...
    def calc_energy_output (self):
        ...
        average_net_energy_output : float
            average energy output of heating oil(mmbtu/sq. ft./hr).
    ...
    def calc_max_boiler_output (self, efficiency):
        ...
        max_boiler_output_per_sf : float
            boiler energy output per square foot (mmbtu/sq. ft.)
    ...
    def calc_biomass_fuel_consumed (self, capacity_factor):
        ...
        biomass_fuel_consumed : float
            biomass fuel consumed (units/year)
        """
